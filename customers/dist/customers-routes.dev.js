    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return regeneratorRuntime.awrap(db.select("*").from("customers").limit(10));
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return regeneratorRuntime.awrap(db("customers").where("id", req.params.id).first());
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.next = 4;
          return regeneratorRuntime.awrap(db("customers").insert(payload));
        ...
        case 4:
          ...
          id = _ref2[0];
          _context3.next = 9;
          return regeneratorRuntime.awrap(db("customers").where("id", id).first());
    ...
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _context4.next = 4;
          return regeneratorRuntime.awrap(db("customers").where("id", req.params.id).update(payload));
    ...
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          _context5.prev = 0;
          _context5.next = 3;
          return regeneratorRuntime.awrap(db("customers").where("id", req.params.id).del());
